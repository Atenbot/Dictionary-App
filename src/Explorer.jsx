...
const Explorer = ( {font} ) => {
  ...
  useEffect(() => {
    const storedValue = sessionStorage.getItem("wordSearched");
    if (storedValue === "true") {
  ...
  useEffect(() => {
    sessionStorage.setItem("wordSearched", wordSearched);
  }, [wordSearched]);
      ...
      <div className="max-w-7xl pt-10 mx-4 dark:bg-primary-800 md:mx-10 lg:mx-64">
        <div className="relative flex items-center">
          <input
            ...
            className={`rounded-2xl bg-primary-300 dark:bg-primary-600 dark:text-primary-300 font-bold w-full px-4 py-4 md:py-4.5 md:text-lg lg:py-5 border-secondary-100 focus:border-1 outline-none ${
              emptyError ? "outline-solid outline-1 outline-secondary-200" : ""
            }`}
          />
          <SearchIcon
            className="absolute right-4 md:scale-120"
            onClick={() => getDefinition(word)}
          />
        </div>
        {emptyError && (
          <p className="text-secondary-200 pt-2 ml-1 md:text-lg">Please, enter a word</p>
        )}
            ...
            <>
              <div className="flex justify-between items-center pt-8">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-secondary-100 text-lg md:text-2xl lg:text-3xl">{definition?.phonetic}</p>
                </div>
              ...
              {definition?.meanings?.map((def, index) => (
                <div className="comp" key={index}>
                  ...
                  <p className="pt-6 dark:text-primary-100 md:text-lg lg:text-xl">Meaning</p>
                      ...
                      {def.definitions
                        ...
                        .map((def, i) => (
                          ...
                          >
                            ...
                            <p className="pt-2 text-primary-500 dark:text-primary-400">
              ...
              {moreThanThree && (
                <div className="flex items-center pt-10 pb-2">
                  ...
                  <button
                    className="rounded-full w-full md:w-48 md:py-2.5 lg:py-3.5 md:mx-auto flex items-center justify-center gap-3 bg-primary-300 dark:bg-primary-600 py-2"
